<?php
// ******************************  Get Master List of Actve Prayer Data For User (e.g. Myprayer list) **************************************
// Called by tec_myprayer.php
session_start();
...
/*Query master prayer listing: visible = 3 (all) and status = 1 */
		...
		$masterprayerresult = $mysql->query($masterprayerquery) or die(" SQL query error at select my prayers. Error #: " . $mysql->errno . " : " . $mysql->error);
