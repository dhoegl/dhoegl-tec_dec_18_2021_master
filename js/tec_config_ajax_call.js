...
//***********************************************************************************************************
    ...
    //Check for 'Group Management Service' subscription (enables Group management functionality) from config.xml
    //activeparam = 7
    var groupservicetext;
    groupservicetext = (navJQ(xml).find('services-groups').text());
    console.log("groupservicetext = " + groupservicetext);
    if (groupservicetext == 'NO') {
        if(document.getElementById("groups_service")) {
            var testgroupservice = document.getElementById("groups_service");
            testgroupservice.style.display = "none";
        }
    }
    //Check for 'Report Management Service' subscription (enables Report management functionality) from config.xml
    //activeparam = 8
    var reportservicetext;
    reportservicetext = (navJQ(xml).find('services-analytics').text());
    console.log("reportservicetext = " + reportservicetext);
    if (reportservicetext == 'NO') {
        if(document.getElementById("reports_service")) {
            var testreportservice = document.getElementById("reports_service");
            testreportservice.style.display = "none";
        }
    }
//***********************************************************************************************************
//***********************************************************************************************************
