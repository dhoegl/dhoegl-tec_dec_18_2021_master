            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card card-body">
                        ...
                        <ul class="card-text">
                            <li class="card-text">
                                Click the <span class="btn btn-success btn-sm">View</span> button on a row below to see more information about a Family member
                            </li>
                            <li class="card-text">
                        ...
                        <ul>
                            <li class="card-text">
                                Click <a href='services/pdf_download2.php'class='btn btn-info btn-sm' role='button'>PDF HERE</a> to download a PDF copy of your Family Directory
                            </li>
                            <li class="card-text">
                                Click <a href='services/csv_download_directory.php'class='btn btn-info btn-sm' role='button'>CSV HERE</a> to download a spreadsheet copy of your Family Directory
                            </li>
                        </ul>
                    </div>
                </div><!-- col-sm-12 -->
