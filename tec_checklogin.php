...
//        $row = $result->fetch();
        ...
        if($row['active']==1)
        {
            ...
            $_SESSION['global_admin'] = $row['global_admin']; // Global Administrator
            ...
            $_SESSION['reports_admin'] = $row['admin_reports']; // Reports Administrator
        ...
        /*		Access Log entry  */
        	...
        	$accessquery = $mysql->query("INSERT INTO " . $_SESSION['accesslogtable'] . "(type, member_id, user_id, client_ip, client_browser) VALUES ('Login', '" . $_SESSION['user_id'] . "', '" . $_SESSION['username'] . "', '" . $client_ip . "', '" . $client_browser . "')");
