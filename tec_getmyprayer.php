<?php
// Called from tec_view_myprayerlist.php
// Updated 20220106
session_start();
...
// Prepend array with parent element
		...
		while($myrow = $myprayerresult->fetch_assoc()) {
				...
				$myupdate_button = "<td><a class='btn btn-success btn-sm' href='#'>Manage</a></td>";
				$myprayer_text = "<td>" . $myrow['prayertext'] . "</td></tr>";

				// Stores each database record to an array 
					$buildjson = array($myprayercontrol, $myprayerid, $myprayerupdate, $myprayer_title, $myprayanswer, $myupdate_button, $fullname, $mypraypraise, $myprayer_text); 
