...
session_start();
	...
	$prayer_unfollow_tbl_name="prayer_unfollow";
	...
	$groups_tbl_name="groups"; // Service Groups Table name
	$group_cat_tbl_name="group_categories"; // Group Categories Table name
	$group_own_mem_tbl_name="group_owner_member"; // Group Owners & Members registry 
	...
	$config_settings='config_settings'; // Config Settings


	$_SESSION['configsettingstable'] = $config_settings;
	...
	$_SESSION['prayerunfollow'] = $prayer_unfollow_tbl_name;
	...
	$_SESSION['groupstablename'] = $groups_tbl_name;
	$_SESSION['groupcattablename'] = $group_cat_tbl_name;
	$_SESSION['groupownmem'] = $group_own_mem_tbl_name;
