        ...
        function RegistrantUpdate(data1, data2, data3, data4, data5, data6, data7) {
            ...
            jQ10.ajax({
                ...
                .done(function (jqXHR, textStatus) {
                    ...
                    console.log("ajax response approve success data = " + teststat);
                    console.log("ajax response approve success text = " + teststat2);
                ...
                .fail(function (jqXHR, textStatus) {
                    ...
                    console.log("ajax response approve fail data = " + teststat);
                    console.log("ajax response approve fail text = " + teststat2);
...
<body>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card card-body">
                        ...
                        <ul class="card-text">
                            ...
                            <li>
                                Click on
                                <span class="btn btn-success btn-sm">Approve</span> to notify the registrant that he/she has been approved. Registrant will immediately be able to access the site.
                            </li>
                            <li>
                                Click on
                                <span class="btn btn-danger btn-sm">Reject</span> to reject the registration request. Registrant's request will remain in our database, but he/she will be unable to access the site.
                            </li>
                        </ul>
                    </div><!-- card -->
                </div><!-- col-sm-6 -->
                <div class="col-sm-6">
                    <div class="card card-body">
                        <h4 class="card-title">
                            Click on the
                            <span class="btn btn-primary btn-sm">Send Email</span> button to send an email to the registration request originator
                        </h4>
                        <ul class="card-text">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content bg-light">
                ...
                <div class="modal-body">
                    ...
                    <form name='rejectreg' method='post' action="javascript:void(0);">
                        <div class="modal-footer">
    ...
    <!-- <script type="txt/javascript" src="js/MDBootstrap4191/bootstrap.min.js"></script> -->
    <!-- MDB core JavaScript -->
