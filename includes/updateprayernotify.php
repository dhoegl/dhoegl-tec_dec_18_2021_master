<?php
/* Send email to members with 'prayer_follow = '1' for the updated prayer'; called from 'tec_updateprayer.php */
...
//		eventLogUpdate('mail', $prayer_name, 'Update emails sent', $prayernotifyresultcount);
	}
	else {
