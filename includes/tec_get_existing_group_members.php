<?php
// tec_get_existing_group_members (members of chosen group)  
...
//     array_push($listarray, $buildjson);
    while($registeredusersqueryrow = $registeredusersqueryresult->fetch_assoc()) 
    {
        ...
        $member_select_ID = "MemberID_" . $registeredusersqueryrow['login_ID'];
        $member_select = "<tr><td><input type='checkbox' id='" . $member_select_ID . "'></td>";
        ...
        $buildjson = array($member_select, $lastname, $firstname, $email, $loginID, $churchID);
