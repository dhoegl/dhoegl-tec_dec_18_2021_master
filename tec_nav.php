  ...
  <?php
        ...
        if($_SESSION['super_admin'] == '1')
        {
          if($activeparam == '5')
          {
              ...
              // echo '<a class="dropdown-item" href="tec_myprayer.php">New Prayer Request</a>';
              echo '</div></li>';
          }
          else
          {
        ...
        if($_SESSION['global_admin'] == '1')
        {
          if($activeparam == '12')
          {
              echo '<li class="nav-item active"><a class="nav-link" href="tec_admin.php">**Ourfamilyconnections Admin**</a></li>';
          }
          else
          {
              echo '<li class="nav-item"><a class="nav-link" href="tec_admin.php">**Ourfamilyconnections Admin**</a></li>';
          }
        }
        if($_SESSION['reports_admin'] == '1')
        {
          if($activeparam == '7')
          {
              echo '<li class="nav-item active" id="group_service"><a class="nav-link" href="tec_groups.php">**Groups Admin**</a></li>';
          }
          else
          {
              echo '<li class="nav-item" id="group_service"><a class="nav-link" href="tec_groups.php">**Groups Admin**</a></li>';
          }
        }
        if($_SESSION['reports_admin'] == '1')
        {
          if($activeparam == '8')
          {
              echo '<li class="nav-item active"><a class="nav-link" href="tec_reports.php">**Reports Admin**</a></li>';
          }
          else
          {
              echo '<li class="nav-item"><a class="nav-link" href="tec_reports.php">**Reports Admin**</a></li>';
          }
        }
