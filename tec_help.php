...
<div class="row pt-2">
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="card bg-light border-primary p-3 mt-2 my-2">
            <div class="card-body">
                <h4 class="card-title font-weight-bold">KNOWN ISSUES</h4>
                <h6 class="card-text font-weight-bold my-2">The following known issues are being worked on with priority</h6>
                <div class="faq_container">
                    <div class="faq">
                        <div class="faq_question">I am getting a white screen when I submit a new or updated prayer request</div>
                        <div class="faq_answer_container">
                            <div class="faq_answer">
                                <div class="card-text font-weight-normal ml-2">
                                <b>Do you have Last Pass installed? </b>If you have a carriage return in your prayer request text (or update), and use the Last Pass password manager,
                                you may experience a white (blank) screen when you click 'SUBMIT' on a new prayer request or update, and must restart the app.
                                <ul>
                                    <li><b>WORKAROUND: </b>Temporarily disable Last Pass before submitting your prayer request or update.</li>
                                    <li>After submission, re-enable Last Pass in your browser to begin using Last Pass features.</li>
                                </ul>
                                <ul>
                                   <li>Instructions on how to enable/disable Last Pass can be found at the <a href="https://support.logmeininc.com/lastpass/help/how-do-i-enable-or-disable-my-web-browsers-password-manager-lp010129" target=“_blank”>Last Pass website</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="faq_container">
				            ...
				            <div class="faq">
						        ...
						        <div class="faq_answer_container">
							        <div class="faq_answer">Prayer requests are enabled in the TEC App. However, knowing that the TEC App limits visibility to prayer requests to only the group it was submitted, we are considering the re-instatement of the prayer request functionality in the TEC Directory. Stay tuned!</div>
                                </div>
                                <hr style="height:2px; color: DarkOrange">		
				            </div>
			            </div>
