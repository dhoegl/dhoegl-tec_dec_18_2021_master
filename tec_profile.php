  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="ModalProfilePicLabel">Upload New Photo<br />Click Save when done.</h4>
...
<div class="modal fade" id="ModalContactInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Edit Contact Info<br />Click Save when done.</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="ModalCalendarInfo" tabindex="-1" role="dialog" aria-labelledby="ModalCalendar" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="ModalCalendar">Edit Anniversary and Birthdays<br />Click Save when done.</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <form class="text-center border border-light p-2" name='editcalendar' method='post' action='services/tec_profile_calendar_update.php'> 		
                    <table id="editcalendartable" border='0' cellpadding='0' cellspacing='1' >
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td colspan="3" align='right'>
                                <button type="submit" name="submitcalendar" class="btn btn-primary">Save</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                            </td>
                        </tr>
                    </table>
...
<div class="modal fade" id="ModalChildrenInfo" tabindex="-1" role="dialog" aria-labelledby="ModalChildren" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="ModalChildren">Edit Children Info<br />Click Save when done.</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
...
<div id="child1edit" class="table-responsive">
    ...
    <div class="border border-light p-2">
            <div class="md-form">
                ...
                <div class="h6-responsive red-text font-weight-bold text-center">REMEMBER: click Save before moving to next child</div>
            </div>
    </div>
    <div class="modaleditform text-center border border-light p-2">
        <div class="table-responsive">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit1children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child2edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit2children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child3edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit3children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child4edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit4children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child5edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit5children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child6edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit6children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child7edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit7children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<div id="child8edit" class="table-responsive">
    ...
    <div class="modaleditform text-center border border-light p-2">
        ...
        <tr>
            ...
            <td></td>
            <td colspan="3" align='right'>
                <button type="submit" name="submit8children" class="btn btn-primary">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
